...
public class FullyAnchoredSearchFilter extends TokenFilter {
  ...
  private static final Logger LOGGER = LoggerFactory
                                         .getLogger(FullyAnchoredSearchFilter.class);
  ...
  /**
   * Create a new FullyAnchoredSearchFilter around <code>input</code>. As with
   * any normal TokenFilter, do <em>not</em> call reset on the input; this filter
   * will do it normally.
   */
  FullyAnchoredSearchFilter(TokenStream input) {
    super(input);
    reset_everything();
  }
