 ...
 *     &lt;/fieldType&gt;
 */
public class StartsWithPhraseMatchFilterFactory extends TokenFilterFactory {
  public StartsWithPhraseMatchFilterFactory(Map<String, String> aMap) {
      super(aMap);
  }

  @Override
    public StartsWithPhraseMatchFilter create(TokenStream aTokenStream) {
      return new StartsWithPhraseMatchFilter(aTokenStream);
  }
